...
//                 <div>
//                     <h1 className="text-3xl font-extrabold text-black dark:text-white ">Social Links</h1>
//                     <p className="text-sm text-gray-500 mt-1">Manage company social media URLs (per platform).</p>
//                 </div>

//                 <div className="flex items-center gap-4">
//                     <div className="flex items-center  border border-black dark:border-gray-600 rounded-md px-3 py-1 shadow-sm">
...
//                             className="outline-none text-sm text-black dark:text-white "
//                         />
//                     </div>
...
//             {/* Table container */}
//             <div className=" border dark:border-white90 border-black rounded-lg shadow-sm overflow-x-auto">
...
//                             <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">URL</th>
